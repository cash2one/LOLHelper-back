...
var combatList = function(areaid , qquin , callback){
    var options = {
        url :`http://api.pallas.tgp.qq.com/core/get_player_battle_list?p=[[3,{"area_id":"${areaid}","qquin":"${qquin}","bt_num":"0","bt_list":[],"champion_id":0,"offset":0,"limit":8,"mvp_flag":-1}]]`,
        method : "GET",
        headers:{
            "Accept":"image/sharpp,*/*",
            ...
            "Referer":"http://game.tgp.qq.com/lol/profile/v1602/overview.shtml?qquin="+ qquin +"&area_id=" + areaid,
    ...
    request(options , function(err,res,body){
        if(err){
            ...
            if(t.retCode === 0){
                callback(false,t.data[0]["battle_list"]);
            }else{
                callback(true,t.msg);
            }
        }
