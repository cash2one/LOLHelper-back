...
var userHotInfo = function(areaid , qquin , callback){
    var options = {
        url : "http://api.pallas.tgp.qq.com/core/get_user_hot_info?area_id=" + areaid + "&qquin=" + qquin,
        method : "GET",
        headers:{
            "Accept":"image/sharpp,*/*",
