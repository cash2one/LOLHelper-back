...
var userArea = function(keyword , callback){
    var options = {
        url : "http://api.pallas.tgp.qq.com/core/search_player?key=" + encodeURIComponent(keyword),
        method : "GET",
        headers:{
            "Accept":"image/sharpp,*/*",
            ...
            "Referer":"http://game.tgp.qq.com/lol/search/v1603/search.html?kw=" + encodeURIComponent(keyword),
