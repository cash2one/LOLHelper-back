...
var combatDetail = function(areaid , qquin , gameid , callback){
    var options = {
        url :`http://api.pallas.tgp.qq.com/core/get_battle_info?p={"area_id":"${areaid}","game_id":"${gameid}"}`,
        method : "GET",
        headers:{
            "Accept":"image/sharpp,*/*",
            ...
            "Referer":`http://game.tgp.qq.com/lol/profile/v1602/history.shtml?qquin=${qquin}&area_id=${areaid}&game_id=${gameid}&battle_type=0&champion_id=0&cur_page=1`,
