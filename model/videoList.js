...
var videoList = function(callback){
    ...
    request(options,function(err,res,body){
        if(err){
            ...
            console.log(t);
            try{
                callback(false,t.data['info_list']);
            }catch(err){
                console.log(err);
            }
        }
